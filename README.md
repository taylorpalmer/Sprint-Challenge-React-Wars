...
- [x] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
  ...
  React is a Javascript library for building user interfaces. It allows developers to write HTML-like code as JSX in a Javascript file and eliminates the need to do the createElement, className.add flow for every element. React allows seperation of concerns based on components of the site rather than seperate files for HTML, CSS, JS.

- [x] What does it mean to _think_ in react?

  It means to think in terms of components and component heirarchies.

- [x] Describe state.

  The state is an instance of React Component Class as an object of a set of observable properties that control the behavior of the component.

- [x] Describe props.

  Props are properties that are passed through arguments and parameters that are inherited from parent components to children and grandchildren and so on. They use dot notation to access desired parts of data.

- [x] What are side effects, and how do you sync effects in a React component to state or prop changes?

  A side effect is anything that affects something outside the scope of the function being executed. You sync effects with the useEffect hook.
